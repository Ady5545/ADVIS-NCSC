...
import { Atom, POrbital, SOrbital, HybridOrbital, Electron, Bond, LonePair, HolographicGrid, MeasurementArc } from './ChemistryPrimitives';

// Helper component for smooth continuous animation of position, rotation, and scale
export function AnimGroup({ 
  ...
  useFrame((state, delta) => {
    ...
    easing.damp3(ref.current.position, position, 0.25, delta);
    ...
    <Float rotationIntensity={isSummary ? 0.5 : 0.1}>
      ...
      {isWater && showOrbitals && (
         <group>
            ...
            {/* Molecular Geometry Measurement Metrics */}
